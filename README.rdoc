...
* Version 1.0 of this gem if sor Phidget Lib 2.2. For the older Phidget Lib 2.1, use version 0.1.3 of the gem.
...
* The development header file and library must be placed in a location where the compiler can find them.
  ...
  RUBY_DIR\\include\\ruby-1.9.1. phidget22.lib can be copied to RUBY_DIR\\lib.
